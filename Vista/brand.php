    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Administrar marca</div>
        ...
        <form class="form-horizontal" id="submitBrandForm" action="../php_action/DAO/createBrand.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                <label for="brandName" class="col-sm-3 control-label">Nombre de la marca: </label>
                <label class="col-sm-1 control-label">: </label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="brandName" placeholder="Nombre de la marca" name="brandName" autocomplete="off">
                    </div>
          ...
          <div class="modal-body">
            ...
            <div class="modal-loading div-hide" style="width:50px; margin:auto;padding-top:50px; padding-bottom:50px;">
              ...
              <div class="edit-brand-result">
                <div class="form-group">
                    <label for="editBrandName" class="col-sm-3 control-label">Nombre de la marca: </label>
                    <label class="col-sm-1 control-label">: </label>
                        <div class="col-sm-8">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Quitar marca</h4>
      </div>
      <div class="modal-body">
        <p>¿Realmente quieres eliminarlo?</p>
      </div>
